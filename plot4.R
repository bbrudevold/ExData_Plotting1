...
grap <- as.numeric(ps$Global_reactive_power)
...
plot(dateTime,gap,xlab="",ylab="Global Active Power",main="",type="l")

# build a plot of voltage versus time
plot(dateTime,v,xlab="datetime",ylab="Voltage",main="",type="l")
...
# build a plot of global reactive power versus time 
plot(dateTime,grap,xlab="datetime",ylab="Global_reactive_power",main="",type="l")
